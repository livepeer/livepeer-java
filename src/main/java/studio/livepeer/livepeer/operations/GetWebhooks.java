...
public class GetWebhooks {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetWebhooksResponse> {
        ...
        public GetWebhooksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withData(Utils.unmarshal(response, new TypeReference<List<Webhook>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<studio.livepeer.livepeer.models.operations.async.GetWebhooksResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetWebhooksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetWebhooksResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetWebhooksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetWebhooksResponse res = resBuilder.build();
