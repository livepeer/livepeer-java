...
public class AddMultistreamTarget {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddMultistreamTargetRequest, AddMultistreamTargetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddMultistreamTargetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMultistreamTargetRequest.class, new TypeReference<AddMultistreamTargetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddMultistreamTargetRequest request) {
        ...
        @Override
        public AddMultistreamTargetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddMultistreamTargetResponse.Builder resBuilder =
            ...
            AddMultistreamTargetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddMultistreamTargetRequest, studio.livepeer.livepeer.models.operations.async.AddMultistreamTargetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddMultistreamTargetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMultistreamTargetRequest.class, new TypeReference<AddMultistreamTargetRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddMultistreamTargetRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.AddMultistreamTargetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.AddMultistreamTargetResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.AddMultistreamTargetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.AddMultistreamTargetResponse res = resBuilder.build();
