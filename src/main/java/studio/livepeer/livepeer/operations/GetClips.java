...
public class GetClips {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClipsRequest, GetClipsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClipsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClipsRequest request) {
        ...
        @Override
        public GetClipsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClipsResponse.Builder resBuilder =
                    GetClipsResponse
                            .builder()
            ...
            GetClipsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClipsRequest, studio.livepeer.livepeer.models.operations.async.GetClipsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClipsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClipsRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetClipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetClipsResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetClipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetClipsResponse res = resBuilder.build();
