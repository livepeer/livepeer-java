...
public class RemoveMultistreamTarget {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMultistreamTargetRequest, RemoveMultistreamTargetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMultistreamTargetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMultistreamTargetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMultistreamTargetRequest request) {
        ...
        @Override
        public RemoveMultistreamTargetResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMultistreamTargetRequest, studio.livepeer.livepeer.models.operations.async.RemoveMultistreamTargetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMultistreamTargetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMultistreamTargetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMultistreamTargetRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.RemoveMultistreamTargetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.RemoveMultistreamTargetResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.RemoveMultistreamTargetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.RemoveMultistreamTargetResponse res = resBuilder.build();
