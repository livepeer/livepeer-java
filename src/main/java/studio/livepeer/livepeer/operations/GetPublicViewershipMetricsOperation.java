...
public class GetPublicViewershipMetricsOperation implements RequestOperation<GetPublicViewershipMetricsRequest, GetPublicViewershipMetricsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetPublicViewershipMetricsOperation(SDKConfiguration sdkConfiguration) {
