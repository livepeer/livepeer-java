...
public class DeleteStream {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteStreamRequest, studio.livepeer.livepeer.models.operations.async.DeleteStreamResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.DeleteStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.DeleteStreamResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.DeleteStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.DeleteStreamResponse res = resBuilder.build();
