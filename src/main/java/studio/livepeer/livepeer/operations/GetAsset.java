...
public class GetAsset {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAssetRequest, GetAssetResponse> {
        ...
        public GetAssetResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAssetResponse.Builder resBuilder =
                    GetAssetResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAssetRequest, studio.livepeer.livepeer.models.operations.async.GetAssetResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetAssetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetAssetResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetAssetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetAssetResponse res = resBuilder.build();
