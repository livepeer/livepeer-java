...
public class CreateMultistreamTargetOperation implements RequestOperation<MultistreamTargetInput, CreateMultistreamTargetResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateMultistreamTargetOperation(SDKConfiguration sdkConfiguration) {
