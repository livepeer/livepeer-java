...
public class DeleteRoomUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteRoomUserRequest, DeleteRoomUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteRoomUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRoomUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteRoomUserRequest request) {
        ...
        @Override
        public DeleteRoomUserResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteRoomUserRequest, studio.livepeer.livepeer.models.operations.async.DeleteRoomUserResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteRoomUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRoomUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteRoomUserRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.DeleteRoomUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.DeleteRoomUserResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.DeleteRoomUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.DeleteRoomUserResponse res = resBuilder.build();
