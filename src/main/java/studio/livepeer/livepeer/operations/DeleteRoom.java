...
public class DeleteRoom {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteRoomRequest, DeleteRoomResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRoomRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteRoomRequest request) {
        ...
        @Override
        public DeleteRoomResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteRoomRequest, studio.livepeer.livepeer.models.operations.async.DeleteRoomResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRoomRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteRoomRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.DeleteRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.DeleteRoomResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.DeleteRoomResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.DeleteRoomResponse res = resBuilder.build();
