...
public class GetWebhook {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWebhookRequest, studio.livepeer.livepeer.models.operations.async.GetWebhookResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetWebhookResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetWebhookResponse res = resBuilder.build();
