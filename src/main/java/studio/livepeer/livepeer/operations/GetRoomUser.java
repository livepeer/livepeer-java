...
public class GetRoomUser {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRoomUserRequest request) throws Exception {
        ...
        @Override
        public GetRoomUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    studio.livepeer.livepeer.models.components.GetRoomUserResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetRoomUserResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
