...
public class GetWebhookLogsOperation implements RequestOperation<GetWebhookLogsRequest, GetWebhookLogsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetWebhookLogsOperation(SDKConfiguration sdkConfiguration) {
