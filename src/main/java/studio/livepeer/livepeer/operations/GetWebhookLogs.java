...
public class GetWebhookLogs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWebhookLogsRequest, GetWebhookLogsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetWebhookLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookLogsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWebhookLogsRequest request) {
        ...
        @Override
        public GetWebhookLogsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWebhookLogsResponse.Builder resBuilder =
            ...
            GetWebhookLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withData(Utils.unmarshal(response, new TypeReference<List<WebhookLog>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWebhookLogsRequest, studio.livepeer.livepeer.models.operations.async.GetWebhookLogsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetWebhookLogsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookLogsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWebhookLogsRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetWebhookLogsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetWebhookLogsResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetWebhookLogsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetWebhookLogsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<WebhookLog>>() {})
