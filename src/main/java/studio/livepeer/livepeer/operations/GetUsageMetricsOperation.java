...
public class GetUsageMetricsOperation implements RequestOperation<GetUsageMetricsRequest, GetUsageMetricsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetUsageMetricsOperation(SDKConfiguration sdkConfiguration) {
