...
public class CreateRoomUser {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRoomUserRequest request) throws Exception {
        ...
        @Override
        public CreateRoomUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RoomUserResponse out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRoomUserResponse(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
