...
public class CreateClipOperation implements RequestOperation<ClipPayload, CreateClipResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateClipOperation(SDKConfiguration sdkConfiguration) {
