...
public class GetAssets {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetAssetsResponse> {
        ...
        @Override
        public GetAssetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAssetsResponse.Builder resBuilder =
                    GetAssetsResponse
                            .builder()
            ...
            GetAssetsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<studio.livepeer.livepeer.models.operations.async.GetAssetsResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetAssetsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetAssetsResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetAssetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetAssetsResponse res = resBuilder.build();
