...
public class GetMultistreamTargets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetMultistreamTargetsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<MultistreamTarget> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withData(out);
