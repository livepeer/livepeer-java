...
public class DeleteStreamOperation implements RequestOperation<DeleteStreamRequest, DeleteStreamResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteStreamOperation(SDKConfiguration sdkConfiguration) {
