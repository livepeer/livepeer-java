...
public class CreateMultistreamTarget {
    ...
    public static class Sync extends Base
            implements RequestOperation<MultistreamTargetInput, CreateMultistreamTargetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(MultistreamTargetInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MultistreamTargetInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MultistreamTargetInput request) {
        ...
        @Override
        public CreateMultistreamTargetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMultistreamTargetResponse.Builder resBuilder =
            ...
            CreateMultistreamTargetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MultistreamTargetInput, studio.livepeer.livepeer.models.operations.async.CreateMultistreamTargetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(MultistreamTargetInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<MultistreamTargetInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MultistreamTargetInput request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.CreateMultistreamTargetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.CreateMultistreamTargetResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.CreateMultistreamTargetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.CreateMultistreamTargetResponse res = resBuilder.build();
