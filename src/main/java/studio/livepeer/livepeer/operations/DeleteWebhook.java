...
public class DeleteWebhook {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteWebhookRequest, studio.livepeer.livepeer.models.operations.async.DeleteWebhookResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.DeleteWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.DeleteWebhookResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.DeleteWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.DeleteWebhookResponse res = resBuilder.build();
