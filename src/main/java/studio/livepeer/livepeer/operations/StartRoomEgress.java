...
public class StartRoomEgress {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartRoomEgressRequest, StartRoomEgressResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StartRoomEgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartRoomEgressRequest.class, new TypeReference<StartRoomEgressRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartRoomEgressRequest request) {
        ...
        @Override
        public StartRoomEgressResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartRoomEgressResponse.Builder resBuilder =
            ...
            StartRoomEgressResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartRoomEgressRequest, studio.livepeer.livepeer.models.operations.async.StartRoomEgressResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StartRoomEgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartRoomEgressRequest.class, new TypeReference<StartRoomEgressRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartRoomEgressRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.StartRoomEgressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.StartRoomEgressResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.StartRoomEgressResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.StartRoomEgressResponse res = resBuilder.build();
