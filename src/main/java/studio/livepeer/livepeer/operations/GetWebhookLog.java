...
public class GetWebhookLog {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWebhookLogRequest, GetWebhookLogResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetWebhookLogRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookLogRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWebhookLogRequest request) {
        ...
        @Override
        public GetWebhookLogResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWebhookLogResponse.Builder resBuilder =
            ...
            GetWebhookLogResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWebhookLogRequest, studio.livepeer.livepeer.models.operations.async.GetWebhookLogResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetWebhookLogRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebhookLogRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWebhookLogRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetWebhookLogResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetWebhookLogResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetWebhookLogResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetWebhookLogResponse res = resBuilder.build();
