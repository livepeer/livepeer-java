...
public class UpdateAssetOperation implements RequestOperation<UpdateAssetRequest, UpdateAssetResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateAssetOperation(SDKConfiguration sdkConfiguration) {
