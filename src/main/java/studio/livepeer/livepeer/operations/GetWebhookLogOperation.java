...
public class GetWebhookLogOperation implements RequestOperation<GetWebhookLogRequest, GetWebhookLogResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetWebhookLogOperation(SDKConfiguration sdkConfiguration) {
