...
public class GetRealtimeViewershipNowOperation implements RequestOperation<GetRealtimeViewershipNowRequest, GetRealtimeViewershipNowResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetRealtimeViewershipNowOperation(SDKConfiguration sdkConfiguration) {
