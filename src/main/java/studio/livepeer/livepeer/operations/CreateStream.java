...
public class CreateStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<NewStreamPayload, CreateStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(NewStreamPayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<NewStreamPayload>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(NewStreamPayload request) {
        ...
        @Override
        public CreateStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateStreamResponse.Builder resBuilder =
            ...
            CreateStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStream(Utils.unmarshal(response, new TypeReference<Stream>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<NewStreamPayload, studio.livepeer.livepeer.models.operations.async.CreateStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(NewStreamPayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<NewStreamPayload>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(NewStreamPayload request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.CreateStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.CreateStreamResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.CreateStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.CreateStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Stream>() {})
                            .thenApply(res::withStream);
                } else {
