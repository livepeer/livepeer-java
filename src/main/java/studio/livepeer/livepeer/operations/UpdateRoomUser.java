...
public class UpdateRoomUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRoomUserRequest, UpdateRoomUserResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRoomUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRoomUserRequest.class, new TypeReference<UpdateRoomUserRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRoomUserRequest request) {
        ...
        @Override
        public UpdateRoomUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRoomUserResponse.Builder resBuilder =
            ...
            UpdateRoomUserResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRoomUserRequest, studio.livepeer.livepeer.models.operations.async.UpdateRoomUserResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRoomUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRoomUserRequest.class, new TypeReference<UpdateRoomUserRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRoomUserRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.UpdateRoomUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.UpdateRoomUserResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.UpdateRoomUserResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.UpdateRoomUserResponse res = resBuilder.build();
