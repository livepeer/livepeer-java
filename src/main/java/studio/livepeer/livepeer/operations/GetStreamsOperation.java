...
public class GetStreamsOperation implements RequestOperation<GetStreamsRequest, GetStreamsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetStreamsOperation(SDKConfiguration sdkConfiguration) {
