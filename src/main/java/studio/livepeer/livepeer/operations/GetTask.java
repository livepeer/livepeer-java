...
public class GetTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskRequest, GetTaskResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskRequest request) {
        ...
        @Override
        public GetTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskResponse.Builder resBuilder =
                    GetTaskResponse
                            .builder()
            ...
            GetTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskRequest, studio.livepeer.livepeer.models.operations.async.GetTaskResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetTaskResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetTaskResponse res = resBuilder.build();
