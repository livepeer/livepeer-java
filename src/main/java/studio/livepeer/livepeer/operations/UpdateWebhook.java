...
public class UpdateWebhook {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateWebhookRequest, studio.livepeer.livepeer.models.operations.async.UpdateWebhookResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.UpdateWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.UpdateWebhookResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.UpdateWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.UpdateWebhookResponse res = resBuilder.build();
