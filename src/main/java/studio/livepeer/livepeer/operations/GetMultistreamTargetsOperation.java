...
public class GetMultistreamTargetsOperation implements RequestlessOperation<GetMultistreamTargetsResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetMultistreamTargetsOperation(SDKConfiguration sdkConfiguration) {
