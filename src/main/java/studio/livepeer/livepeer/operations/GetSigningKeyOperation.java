...
public class GetSigningKeyOperation implements RequestOperation<GetSigningKeyRequest, GetSigningKeyResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetSigningKeyOperation(SDKConfiguration sdkConfiguration) {
