...
public class DeleteMultistreamTargetOperation implements RequestOperation<DeleteMultistreamTargetRequest, DeleteMultistreamTargetResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteMultistreamTargetOperation(SDKConfiguration sdkConfiguration) {
