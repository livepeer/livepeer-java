...
public class RequestUpload {
    ...
    public static class Sync extends Base
            implements RequestOperation<NewAssetPayload, RequestUploadResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(NewAssetPayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<NewAssetPayload>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(NewAssetPayload request) {
        ...
        @Override
        public RequestUploadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RequestUploadResponse.Builder resBuilder =
            ...
            RequestUploadResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withData(Utils.unmarshal(response, new TypeReference<RequestUploadData>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<NewAssetPayload, studio.livepeer.livepeer.models.operations.async.RequestUploadResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(NewAssetPayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<NewAssetPayload>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(NewAssetPayload request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.RequestUploadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.RequestUploadResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.RequestUploadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.RequestUploadResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RequestUploadData>() {})
