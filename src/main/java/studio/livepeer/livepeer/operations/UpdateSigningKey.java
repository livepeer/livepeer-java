...
public class UpdateSigningKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSigningKeyRequest, UpdateSigningKeyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSigningKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningKeyRequest.class, new TypeReference<UpdateSigningKeyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSigningKeyRequest request) {
        ...
        @Override
        public UpdateSigningKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSigningKeyResponse.Builder resBuilder =
            ...
            UpdateSigningKeyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSigningKeyRequest, studio.livepeer.livepeer.models.operations.async.UpdateSigningKeyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSigningKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningKeyRequest.class, new TypeReference<UpdateSigningKeyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSigningKeyRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.UpdateSigningKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.UpdateSigningKeyResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.UpdateSigningKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.UpdateSigningKeyResponse res = resBuilder.build();
