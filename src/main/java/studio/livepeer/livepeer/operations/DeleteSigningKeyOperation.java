...
public class DeleteSigningKeyOperation implements RequestOperation<DeleteSigningKeyRequest, DeleteSigningKeyResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteSigningKeyOperation(SDKConfiguration sdkConfiguration) {
