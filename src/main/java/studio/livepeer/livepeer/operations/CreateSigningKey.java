...
public class CreateSigningKey {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<studio.livepeer.livepeer.models.operations.async.CreateSigningKeyResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.CreateSigningKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.CreateSigningKeyResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.CreateSigningKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.CreateSigningKeyResponse res = resBuilder.build();
