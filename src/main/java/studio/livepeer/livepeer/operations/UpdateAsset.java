...
public class UpdateAsset {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAssetRequest, UpdateAssetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssetRequest.class, new TypeReference<UpdateAssetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAssetRequest request) {
        ...
        @Override
        public UpdateAssetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAssetResponse.Builder resBuilder =
                    UpdateAssetResponse
                            .builder()
            ...
            UpdateAssetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAsset(Utils.unmarshal(response, new TypeReference<Asset>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAssetRequest, studio.livepeer.livepeer.models.operations.async.UpdateAssetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssetRequest.class, new TypeReference<UpdateAssetRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAssetRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.UpdateAssetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.UpdateAssetResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.UpdateAssetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.UpdateAssetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Asset>() {})
                            .thenApply(res::withAsset);
                } else {
