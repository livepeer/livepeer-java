...
public class RequestUploadOperation implements RequestOperation<NewAssetPayload, RequestUploadResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public RequestUploadOperation(SDKConfiguration sdkConfiguration) {
