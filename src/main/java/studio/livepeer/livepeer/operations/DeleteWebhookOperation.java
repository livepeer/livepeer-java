...
public class DeleteWebhookOperation implements RequestOperation<DeleteWebhookRequest, DeleteWebhookResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteWebhookOperation(SDKConfiguration sdkConfiguration) {
