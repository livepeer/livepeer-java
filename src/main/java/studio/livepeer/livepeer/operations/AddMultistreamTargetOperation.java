...
public class AddMultistreamTargetOperation implements RequestOperation<AddMultistreamTargetRequest, AddMultistreamTargetResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public AddMultistreamTargetOperation(SDKConfiguration sdkConfiguration) {
