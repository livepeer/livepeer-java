...
public class GetStream {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStreamRequest, studio.livepeer.livepeer.models.operations.async.GetStreamResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetStreamResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetStreamResponse res = resBuilder.build();
