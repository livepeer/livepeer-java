...
public class UpdateSigningKeyOperation implements RequestOperation<UpdateSigningKeyRequest, UpdateSigningKeyResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateSigningKeyOperation(SDKConfiguration sdkConfiguration) {
