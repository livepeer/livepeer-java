...
public class StopRoomEgress {
    ...
    public static class Sync extends Base
            implements RequestOperation<StopRoomEgressRequest, StopRoomEgressResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StopRoomEgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopRoomEgressRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StopRoomEgressRequest request) {
        ...
        @Override
        public StopRoomEgressResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StopRoomEgressRequest, studio.livepeer.livepeer.models.operations.async.StopRoomEgressResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StopRoomEgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopRoomEgressRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StopRoomEgressRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.StopRoomEgressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.StopRoomEgressResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.StopRoomEgressResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.StopRoomEgressResponse res = resBuilder.build();
