...
public class GetSigningKey {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningKeyRequest request) throws Exception {
        ...
        @Override
        public GetSigningKeyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SigningKey out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSigningKey(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
