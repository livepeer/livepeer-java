...
public class GetStreamOperation implements RequestOperation<GetStreamRequest, GetStreamResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetStreamOperation(SDKConfiguration sdkConfiguration) {
