...
public class DeleteSigningKey {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSigningKeyRequest, studio.livepeer.livepeer.models.operations.async.DeleteSigningKeyResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.DeleteSigningKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.DeleteSigningKeyResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.DeleteSigningKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.DeleteSigningKeyResponse res = resBuilder.build();
