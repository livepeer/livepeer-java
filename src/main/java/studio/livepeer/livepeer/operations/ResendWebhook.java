...
public class ResendWebhook {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResendWebhookRequest request) throws Exception {
        ...
        @Override
        public ResendWebhookResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WebhookLog out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWebhookLog(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
