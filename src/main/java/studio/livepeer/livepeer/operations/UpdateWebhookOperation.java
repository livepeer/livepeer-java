...
public class UpdateWebhookOperation implements RequestOperation<UpdateWebhookRequest, UpdateWebhookResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateWebhookOperation(SDKConfiguration sdkConfiguration) {
