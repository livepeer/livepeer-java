...
public class CreateWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<WebhookInput, CreateWebhookResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(WebhookInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<WebhookInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WebhookInput request) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WebhookInput, studio.livepeer.livepeer.models.operations.async.CreateWebhookResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(WebhookInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<WebhookInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WebhookInput request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.CreateWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.CreateWebhookResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.CreateWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.CreateWebhookResponse res = resBuilder.build();
