...
public class GetSigningKeys {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetSigningKeysResponse> {
        ...
        @Override
        public GetSigningKeysResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withData(Utils.unmarshal(response, new TypeReference<List<SigningKey>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<studio.livepeer.livepeer.models.operations.async.GetSigningKeysResponse> {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.GetSigningKeysResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.GetSigningKeysResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.GetSigningKeysResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.GetSigningKeysResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SigningKey>>() {})
