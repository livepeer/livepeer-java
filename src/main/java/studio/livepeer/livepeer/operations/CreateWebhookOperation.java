...
public class CreateWebhookOperation implements RequestOperation<WebhookInput, CreateWebhookResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateWebhookOperation(SDKConfiguration sdkConfiguration) {
