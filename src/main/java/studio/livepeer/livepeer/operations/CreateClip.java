...
public class CreateClip {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClipPayload, CreateClipResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ClipPayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ClipPayload>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClipPayload request) {
        ...
        @Override
        public CreateClipResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateClipResponse.Builder resBuilder =
                    CreateClipResponse
                            .builder()
            ...
            CreateClipResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withData(Utils.unmarshal(response, new TypeReference<CreateClipData>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ClipPayload, studio.livepeer.livepeer.models.operations.async.CreateClipResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ClipPayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ClipPayload>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ClipPayload request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.CreateClipResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.CreateClipResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.CreateClipResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.CreateClipResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateClipData>() {})
