...
public class TranscodeVideo {
    ...
    public static class Sync extends Base
            implements RequestOperation<TranscodePayload, TranscodeVideoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(TranscodePayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TranscodePayload>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TranscodePayload request) {
        ...
        @Override
        public TranscodeVideoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TranscodeVideoResponse.Builder resBuilder =
            ...
            TranscodeVideoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTask(Utils.unmarshal(response, new TypeReference<Task>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TranscodePayload, studio.livepeer.livepeer.models.operations.async.TranscodeVideoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(TranscodePayload request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<TranscodePayload>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TranscodePayload request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.TranscodeVideoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.TranscodeVideoResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.TranscodeVideoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.TranscodeVideoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Task>() {})
                            .thenApply(res::withTask);
                } else {
