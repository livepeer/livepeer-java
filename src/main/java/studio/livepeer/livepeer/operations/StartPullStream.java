...
public class StartPullStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartPullStreamRequest, StartPullStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(StartPullStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartPullStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartPullStreamRequest request) {
        ...
        @Override
        public StartPullStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartPullStreamResponse.Builder resBuilder =
            ...
            StartPullStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartPullStreamRequest, studio.livepeer.livepeer.models.operations.async.StartPullStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StartPullStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartPullStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartPullStreamRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.StartPullStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.StartPullStreamResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.StartPullStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.StartPullStreamResponse res = resBuilder.build();
