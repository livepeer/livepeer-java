...
public class DeleteAsset {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteAssetRequest, DeleteAssetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAssetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteAssetRequest request) {
        ...
        @Override
        public DeleteAssetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteAssetResponse.Builder resBuilder =
                    DeleteAssetResponse
                            .builder()
            ...
            DeleteAssetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteAssetRequest, studio.livepeer.livepeer.models.operations.async.DeleteAssetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAssetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteAssetRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.DeleteAssetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.DeleteAssetResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.DeleteAssetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.DeleteAssetResponse res = resBuilder.build();
