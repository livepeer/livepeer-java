...
public class GetMultistreamTarget {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMultistreamTargetRequest request) throws Exception {
        ...
        @Override
        public GetMultistreamTargetResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MultistreamTarget out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMultistreamTarget(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
