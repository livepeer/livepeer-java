...
public class DeleteAssetOperation implements RequestOperation<DeleteAssetRequest, DeleteAssetResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public DeleteAssetOperation(SDKConfiguration sdkConfiguration) {
