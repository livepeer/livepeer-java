...
public class UpdateStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateStreamRequest, UpdateStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStreamRequest.class, new TypeReference<UpdateStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateStreamRequest request) {
        ...
        @Override
        public UpdateStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateStreamResponse.Builder resBuilder =
            ...
            UpdateStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateStreamRequest, studio.livepeer.livepeer.models.operations.async.UpdateStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStreamRequest.class, new TypeReference<UpdateStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateStreamRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.UpdateStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.UpdateStreamResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.UpdateStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.UpdateStreamResponse res = resBuilder.build();
