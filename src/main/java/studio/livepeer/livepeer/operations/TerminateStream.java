...
public class TerminateStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<TerminateStreamRequest, TerminateStreamResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(TerminateStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminateStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TerminateStreamRequest request) {
        ...
        @Override
        public TerminateStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TerminateStreamResponse.Builder resBuilder =
            ...
            TerminateStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TerminateStreamRequest, studio.livepeer.livepeer.models.operations.async.TerminateStreamResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(TerminateStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminateStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TerminateStreamRequest request) {
        ...
        @Override
        public CompletableFuture<studio.livepeer.livepeer.models.operations.async.TerminateStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            studio.livepeer.livepeer.models.operations.async.TerminateStreamResponse.Builder resBuilder =
                    studio.livepeer.livepeer.models.operations.async.TerminateStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            studio.livepeer.livepeer.models.operations.async.TerminateStreamResponse res = resBuilder.build();
