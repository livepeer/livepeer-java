...
public class UpdateMultistreamTargetOperation implements RequestOperation<UpdateMultistreamTargetRequest, UpdateMultistreamTargetResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateMultistreamTargetOperation(SDKConfiguration sdkConfiguration) {
