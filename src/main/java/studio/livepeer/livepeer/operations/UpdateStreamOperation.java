...
public class UpdateStreamOperation implements RequestOperation<UpdateStreamRequest, UpdateStreamResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public UpdateStreamOperation(SDKConfiguration sdkConfiguration) {
