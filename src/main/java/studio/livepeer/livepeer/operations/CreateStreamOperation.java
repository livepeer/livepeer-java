...
public class CreateStreamOperation implements RequestOperation<NewStreamPayload, CreateStreamResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public CreateStreamOperation(SDKConfiguration sdkConfiguration) {
