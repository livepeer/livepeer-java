...
public class DeleteSigningKeyResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteSigningKeyResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Error
     */
    public DeleteSigningKeyResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public DeleteSigningKeyResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
