...
public class CreateRoomResponse implements studio.livepeer.livepeer.utils.Response {
     ...
     * Error
     */
    public CreateRoomResponse withError(studio.livepeer.livepeer.models.errors.Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public CreateRoomResponse withError(Optional<? extends studio.livepeer.livepeer.models.errors.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
