...
public class DeleteSigningKeyResponse implements studio.livepeer.livepeer.utils.Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteSigningKeyResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Error
     */
    public DeleteSigningKeyResponse withError(studio.livepeer.livepeer.models.errors.Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public DeleteSigningKeyResponse withError(Optional<? extends studio.livepeer.livepeer.models.errors.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
