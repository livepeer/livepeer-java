...
public class DeleteRoomResponse implements studio.livepeer.livepeer.utils.Response {
     ...
     * Error
     */
    public DeleteRoomResponse withError(studio.livepeer.livepeer.models.errors.Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public DeleteRoomResponse withError(Optional<? extends studio.livepeer.livepeer.models.errors.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
