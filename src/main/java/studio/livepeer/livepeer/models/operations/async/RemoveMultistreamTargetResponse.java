...
public class RemoveMultistreamTargetResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RemoveMultistreamTargetResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Error
     */
    public RemoveMultistreamTargetResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public RemoveMultistreamTargetResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
