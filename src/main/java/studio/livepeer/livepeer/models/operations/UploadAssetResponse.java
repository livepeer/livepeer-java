...
public class UploadAssetResponse implements studio.livepeer.livepeer.utils.Response {
     ...
     * Error
     */
    public UploadAssetResponse withError(studio.livepeer.livepeer.models.errors.Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public UploadAssetResponse withError(Optional<? extends studio.livepeer.livepeer.models.errors.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            java.util.Objects.deepEquals(this.twoHundredApplicationJsonData, other.twoHundredApplicationJsonData) &&
            java.util.Objects.deepEquals(this.twoHundredAndOneApplicationJsonData, other.twoHundredAndOneApplicationJsonData) &&
