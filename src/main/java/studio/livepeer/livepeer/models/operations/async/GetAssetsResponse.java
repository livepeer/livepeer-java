...
public class GetAssetsResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAssetsResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Success
     */
    public GetAssetsResponse withData(List<Asset> data) {
        Utils.checkNotNull(data, "data");
     ...
     * Success
     */
    public GetAssetsResponse withData(Optional<? extends List<Asset>> data) {
        Utils.checkNotNull(data, "data");
        this.data = data;
        return this;
    }
     ...
     * Error
     */
    public GetAssetsResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public GetAssetsResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
