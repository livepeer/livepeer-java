...
public class DeleteStreamResponse implements studio.livepeer.livepeer.utils.Response {
     ...
     * Error
     */
    public DeleteStreamResponse withError(studio.livepeer.livepeer.models.errors.Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Error
     */
    public DeleteStreamResponse withError(Optional<? extends studio.livepeer.livepeer.models.errors.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
