...
public class UserTags {
    ...
    public static UserTags of(double value) {
        Utils.checkNotNull(value, "value");
        return new UserTags(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<java.lang.Double>(){}));
    }

    public static UserTags of(List<UserTags3> value) {
        Utils.checkNotNull(value, "value");
        return new UserTags(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<List<UserTags3>>(){}));
    }
     ...
     * <li>{@code double}</li>
     * <li>{@code java.util.List<studio.livepeer.livepeer.models.components.UserTags3>}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<UserTags> {

        public _Deserializer() {
            super(UserTags.class, false,
                  TypeReferenceWithShape.of(new TypeReference<java.util.List<studio.livepeer.livepeer.models.components.UserTags3>>() {}, JsonShape.DEFAULT),
