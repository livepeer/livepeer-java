...
public class Session {
    ...
    /**
     * Whether the stream should be recorded. Uses default settings. For more customization, create and
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.recordingStatus, other.recordingStatus) &&
            Utils.enhancedDeepEquals(this.recordingUrl, other.recordingUrl) &&
            Utils.enhancedDeepEquals(this.mp4Url, other.mp4Url) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            id, kind, userId,
            name, lastSeen, sourceSegments,
            transcodedSegments, sourceSegmentsDuration, transcodedSegmentsDuration,
            sourceBytes, transcodedBytes, ingestRate,
            outgoingRate, isHealthy, issues,
            createdAt, parentId, projectId,
            record, recordingStatus, recordingUrl,
            mp4Url, playbackId, profiles,
            recordingSpec);
    }
