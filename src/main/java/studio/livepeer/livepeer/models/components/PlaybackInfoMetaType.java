...
public enum PlaybackInfoMetaType {
    ...
    PlaybackInfoMetaType(String value) {
        this.value = value;
    }
    ...
    public static Optional<PlaybackInfoMetaType> fromValue(String value) {
        for (PlaybackInfoMetaType o: PlaybackInfoMetaType.values()) {
