 ...
 * ViewershipMetric
 * 
 * <p>An individual metric about viewership of a stream/asset. Necessarily, at least
...
public class ViewershipMetric {
    ...
    public ViewershipMetric(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), viewCount, playtimeMins,
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty());
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.dStorageUrl, other.dStorageUrl) &&
            ...
            Utils.enhancedDeepEquals(this.subdivision, other.subdivision) &&
            Utils.enhancedDeepEquals(this.timezone, other.timezone) &&
            Utils.enhancedDeepEquals(this.geohash, other.geohash) &&
            Utils.enhancedDeepEquals(this.viewCount, other.viewCount) &&
            Utils.enhancedDeepEquals(this.playtimeMins, other.playtimeMins) &&
            Utils.enhancedDeepEquals(this.ttffMs, other.ttffMs) &&
            Utils.enhancedDeepEquals(this.rebufferRatio, other.rebufferRatio) &&
            Utils.enhancedDeepEquals(this.errorRate, other.errorRate) &&
            Utils.enhancedDeepEquals(this.exitsBeforeStart, other.exitsBeforeStart);
    }
    
    @Override
    public int hashCode() {
        return Utils.enhancedHash(
            playbackId, creatorId, viewerId,
            dStorageUrl, timestamp, device,
            deviceType, cpu, os,
            browser, browserEngine, continent,
            country, subdivision, timezone,
            geohash, viewCount, playtimeMins,
            ttffMs, rebufferRatio, errorRate,
            exitsBeforeStart);
    }
