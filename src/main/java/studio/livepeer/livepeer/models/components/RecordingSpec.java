...
public class RecordingSpec {
     ...
     * 
     */
    public RecordingSpec withProfiles(java.util.List<FfmpegProfile> profiles) {
        Utils.checkNotNull(profiles, "profiles");
     ...
     * 
     */
    public RecordingSpec withProfiles(Optional<? extends java.util.List<FfmpegProfile>> profiles) {
        Utils.checkNotNull(profiles, "profiles");
        this.profiles = profiles;
        return this;
    }
