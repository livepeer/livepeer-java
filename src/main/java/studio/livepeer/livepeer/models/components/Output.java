...
public class Output {
    ...
    @JsonProperty("upload")
    private Optional<? extends TaskUpload> upload;
    ...
    @JsonCreator
    public Output(
            @JsonProperty("upload") Optional<? extends TaskUpload> upload,
    ...
    @JsonIgnore
    public Optional<TaskUpload> upload() {
        return (Optional<TaskUpload>) upload;
    }
     ...
     * Output of the upload task
     */
    public Output withUpload(TaskUpload upload) {
        Utils.checkNotNull(upload, "upload");
     ...
     * Output of the upload task
     */
    public Output withUpload(Optional<? extends TaskUpload> upload) {
        Utils.checkNotNull(upload, "upload");
        this.upload = upload;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            Utils.enhancedDeepEquals(this.upload, other.upload) &&
            Utils.enhancedDeepEquals(this.export, other.export) &&
            Utils.enhancedDeepEquals(this.exportData, other.exportData);
    }
    
    @Override
    public int hashCode() {
        return Utils.enhancedHash(
            upload, export, exportData);
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends TaskUpload> upload = Optional.empty();
         ...
         * Output of the upload task
         */
        public Builder upload(TaskUpload upload) {
            Utils.checkNotNull(upload, "upload");
            this.upload = Optional.ofNullable(upload);
            return this;
        }
         ...
         * Output of the upload task
         */
        public Builder upload(Optional<? extends TaskUpload> upload) {
            Utils.checkNotNull(upload, "upload");
            this.upload = upload;
            return this;
        }
