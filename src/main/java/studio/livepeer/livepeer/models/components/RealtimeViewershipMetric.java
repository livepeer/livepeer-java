 ...
 * 
 * <p>An individual metric about realtime viewership of a stream/asset.
 */
public class RealtimeViewershipMetric {
    ...
    public RealtimeViewershipMetric(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), viewCount, errorRate);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            playbackId, device, browser,
            country, viewCount, errorRate);
    }
