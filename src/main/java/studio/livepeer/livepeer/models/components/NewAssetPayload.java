...
public class NewAssetPayload {
     ...
     * Whether to generate MP4s for the asset.
     */
    public NewAssetPayload withStaticMp4(Optional<Boolean> staticMp4) {
        Utils.checkNotNull(staticMp4, "staticMp4");
        this.staticMp4 = staticMp4;
        return this;
    }
     ...
     * Decides if the output video should include C2PA signature
     */
    public NewAssetPayload withC2pa(Optional<Boolean> c2pa) {
        Utils.checkNotNull(c2pa, "c2pa");
        this.c2pa = c2pa;
        return this;
    }

    public NewAssetPayload withProfiles(List<TranscodeProfile> profiles) {
        Utils.checkNotNull(profiles, "profiles");
        this.profiles = JsonNullable.of(profiles);
        return this;
    }

    public NewAssetPayload withProfiles(JsonNullable<? extends List<TranscodeProfile>> profiles) {
        Utils.checkNotNull(profiles, "profiles");
        this.profiles = profiles;
        return this;
    }
     ...
     * How many seconds the duration of each output segment should be
     */
    public NewAssetPayload withTargetSegmentSizeSecs(Optional<Double> targetSegmentSizeSecs) {
        Utils.checkNotNull(targetSegmentSizeSecs, "targetSegmentSizeSecs");
        this.targetSegmentSizeSecs = targetSegmentSizeSecs;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.staticMp4, other.staticMp4) &&
            ...
            Utils.enhancedDeepEquals(this.c2pa, other.c2pa) &&
            Utils.enhancedDeepEquals(this.profiles, other.profiles) &&
            Utils.enhancedDeepEquals(this.targetSegmentSizeSecs, other.targetSegmentSizeSecs);
    }
    
    @Override
    public int hashCode() {
        return Utils.enhancedHash(
            name, staticMp4, playbackPolicy,
            creatorId, storage, encryption,
            c2pa, profiles, targetSegmentSizeSecs);
    }
