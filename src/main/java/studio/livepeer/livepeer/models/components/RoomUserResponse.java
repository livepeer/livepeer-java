...
public class RoomUserResponse {
    ...
    /**
     * Joining URL - use this for Livepeer's default meeting app (see the multiparticipant streaming guide
     * for more info).
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Joining JWT - this can be used if you have a custom meeting app (see the multiparticipant streaming
     * guide for more info).
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("token")
