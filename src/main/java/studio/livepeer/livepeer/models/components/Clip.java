...
public class Clip {
    ...
    /**
     * Strategy to use for clipping the asset. If not specified, the default strategy that Catalyst is
     * configured for will be used. This field only available for admin users, and is only used for E2E
     * testing.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Force to use a specific strategy in the Catalyst pipeline. If not specified, the default strategy
    ...
    public Clip(
            ...
            @JsonProperty("inputId") Optional<String> inputId) {
     ...
     * URL of the asset to "clip"
     */
    public Clip withUrl(Optional<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * ID of the session
     */
    public Clip withSessionId(Optional<String> sessionId) {
        Utils.checkNotNull(sessionId, "sessionId");
        this.sessionId = sessionId;
        return this;
    }
     ...
     * ID of the input asset or stream
     */
    public Clip withInputId(Optional<String> inputId) {
        Utils.checkNotNull(inputId, "inputId");
        this.inputId = inputId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.clipStrategy, other.clipStrategy) &&
            Utils.enhancedDeepEquals(this.catalystPipelineStrategy, other.catalystPipelineStrategy) &&
            Utils.enhancedDeepEquals(this.sessionId, other.sessionId) &&
            Utils.enhancedDeepEquals(this.inputId, other.inputId);
    }
    
    @Override
    public int hashCode() {
        return Utils.enhancedHash(
            url, clipStrategy, catalystPipelineStrategy,
            sessionId, inputId);
    }
    ...
    public final static class Builder {
        ...
        private Optional<String> inputId = Optional.empty();
         ...
         * ID of the input asset or stream
         */
        public Builder inputId(Optional<String> inputId) {
            Utils.checkNotNull(inputId, "inputId");
            this.inputId = inputId;
            return this;
        }
