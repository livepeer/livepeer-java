...
public class Asset {
    ...
    /**
     * URL for HLS playback. **It is recommended to not use this URL**, and instead use playback IDs with
     * the Playback Info endpoint to retrieve the playback URLs - this URL format is subject to change
     * (e.g. https://livepeercdn.com/asset/ea03f37e-f861-4cdd-b495-0e60b6d753ad/index.m3u8).
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public Asset(
        ...
        this(id, Optional.empty(), Optional.empty(),
            ...
            JsonNullable.undefined(), source, Optional.empty(),
            Optional.empty(), Optional.empty(), Optional.empty(),
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.playbackUrl, other.playbackUrl) &&
            ...
            Utils.enhancedDeepEquals(this.videoSpec, other.videoSpec);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            id, type, playbackId,
            userId, playbackUrl, downloadUrl,
            playbackPolicy, source, creatorId,
            profiles, storage, status,
            name, projectId, createdAt,
            createdByTokenName, size, hash,
            videoSpec);
    }
