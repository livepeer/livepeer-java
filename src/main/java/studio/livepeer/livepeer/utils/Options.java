...
public class Options {
    ...
    private Optional<studio.livepeer.livepeer.utils.RetryConfig> retryConfig = Optional.empty();

    private Options(Optional<studio.livepeer.livepeer.utils.RetryConfig> retryConfig) {
        Utils.checkNotNull(retryConfig, "retryConfig");
        this.retryConfig = retryConfig;
    }

    public Optional<studio.livepeer.livepeer.utils.RetryConfig> retryConfig() {
        return retryConfig;
    }
    ...
    public final static class Builder {
        ...
        public Builder retryConfig(Optional<studio.livepeer.livepeer.utils.RetryConfig> retryConfig) throws IllegalArgumentException {
            Utils.checkNotNull(retryConfig, "retryConfig");
            this.retryConfig = retryConfig;
            return this;
        }
