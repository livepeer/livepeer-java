...
public class Transcode {
    ...
    private final AsyncTranscode asyncSDK;

    Transcode(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncTranscode(this, sdkConfiguration);
    }
     ...
     */
    public TranscodeVideoResponse create(TranscodePayload request) throws Exception {
