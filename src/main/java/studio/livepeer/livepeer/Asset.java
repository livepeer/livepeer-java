...
import studio.livepeer.livepeer.operations.DeleteAssetOperation;
import studio.livepeer.livepeer.operations.GetAssetOperation;
import studio.livepeer.livepeer.operations.GetAssetsOperation;
import studio.livepeer.livepeer.operations.RequestUploadOperation;
import studio.livepeer.livepeer.operations.UpdateAssetOperation;
import studio.livepeer.livepeer.operations.UploadAssetOperation;
...
public class Asset {
    ...
    public RequestUploadResponse create(
        ...
        RequestOperation<NewAssetPayload, RequestUploadResponse> operation
              = new RequestUploadOperation( sdkConfiguration);
    ...
    public UploadAssetResponse createViaUrl(
        ...
        RequestOperation<NewAssetFromUrlPayload, UploadAssetResponse> operation
              = new UploadAssetOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
    ...
    public GetAssetResponse get(
        ...
        RequestOperation<GetAssetRequest, GetAssetResponse> operation
              = new GetAssetOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
    ...
    public DeleteAssetResponse delete(
        ...
        RequestOperation<DeleteAssetRequest, DeleteAssetResponse> operation
              = new DeleteAssetOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
