...
import studio.livepeer.livepeer.operations.GetCreatorViewershipMetricsOperation;
...
import studio.livepeer.livepeer.operations.GetUsageMetricsOperation;
...
public class Metrics {
    ...
    public GetCreatorViewershipMetricsResponse getCreatorViewership(
        ...
        RequestOperation<GetCreatorViewershipMetricsRequest, GetCreatorViewershipMetricsResponse> operation
              = new GetCreatorViewershipMetricsOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
    ...
    public GetUsageMetricsResponse getUsage(
        ...
        RequestOperation<GetUsageMetricsRequest, GetUsageMetricsResponse> operation
              = new GetUsageMetricsOperation( sdkConfiguration);
        return operation.handleResponse(operation.doRequest(request));
    }
