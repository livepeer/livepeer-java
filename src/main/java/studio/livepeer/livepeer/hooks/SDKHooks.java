package studio.livepeer.livepeer.hooks;
...
public final class SDKHooks {
    ...
    public static void initialize(studio.livepeer.livepeer.utils.Hooks hooks) {
    ...
    public static void initialize(studio.livepeer.livepeer.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(studio.livepeer.livepeer.utils.HookAdapters.adapt(mySyncHook));
